...
export default function PMJobDetails({ jobId }) {
  ...
  // ✅ local lock to prevent overwrite within the same open session
  ...
  return (
    <div className="container" style={{ paddingTop: 16 }}>
      ...
      {/* ✅ Collapsible: Applicants — Applied */}
      <CollapsibleSection
      ...
      {/* ✅ Collapsible: Applicants — Approved */}
      <CollapsibleSection
      ...
      {/* ✅ Collapsible: Applicants — Rejected */}
      <CollapsibleSection
      ...
      {/* ✅ Collapsible: Approved List & Attendance */}
      <CollapsibleSection
        title="Approved List & Attendance"
        count={approvedRows.length}
        open={showAttendance}
        onToggle={() => setShowAttendance((v) => !v)}
      >
        <div style={{ overflowX: "auto" }}>
