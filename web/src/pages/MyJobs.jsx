                          ...
                          <div style={{ marginTop: 4 }}>
                            ...
                            <div style={{ marginTop: 8, display: "grid", gap: 10 }}>
                                ...
                                {myReceipts.length === 0 ? (
                                  ...
                                  myReceipts.map((r) => (
                                    ...
                                    >
                                      ...
                                      <button className="btn" onClick={() => setImgOpen(r.photoUrlAbs || r.photoUrl)}>
                                        View
                                      </button>
                              ...
                              <div style={{ display: "flex", gap: 10, alignItems: "center", flexWrap: "wrap" }}>
                                ...
                                <input
                                  ref={(el) => {
                                    if (el) fileInputRefs.current[j.id] = el;
                                  }}
                                  type="file"
                                  ...
                                  onChange={async (e) => {
                                    ...
                                    await onPickReceipt(j.id, f);
                                    // ✅ IMPORTANT: clear input value so selecting the SAME file again still triggers onChange
                                    e.target.value = "";
                                  }}
                                />
                              
                                {/* Custom button */}
                                <button className="btn" onClick={() => openPicker(j.id)}>
                                  {draft?.fileName ? "Change image" : "Choose receipt image"}
                                </button>
                              
                                {/* ✅ Your own filename display (this is what “stays there”) */}
                                {draft?.fileName && (
                                  <span style={{ fontSize: 13, color: "#374151" }}>
